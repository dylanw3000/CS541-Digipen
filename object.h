...
class Object
{
 public:
    ...
    Object(Shape* _shape, const int objectId,
           const glm::vec3 _d=glm::vec3(), const glm::vec3 _s=glm::vec3(), const float _n=1, const bool _reflective=false);
    ...
    void DrawNonreflective(ShaderProgram* program, glm::mat4& objectTr);
